  ...
  return (
    <>
      ...
      <a 
        ...
        aria-label="Chat with Sri Ayyappa Hospital on WhatsApp"
      >
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
        <div className="flex">
          <a href="tel:+919000353462" aria-label="Call Sri Ayyappa Hospital" className="flex-1 py-3 flex flex-col items-center justify-center gap-1 text-gray-700 hover:text-medical-blue transition-colors">
            <Phone size={20} />
            <span className="text-[10px] font-semibold uppercase tracking-wide">Call Now</span>
          </a>
          <a href="https://wa.me/919000353462" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp Sri Ayyappa Hospital" className="flex-1 py-3 flex flex-col items-center justify-center gap-1 text-green-600 bg-green-50 hover:bg-green-100 transition-colors border-x border-gray-100">
            <MessageCircle size={20} />
            <span className="text-[10px] font-semibold uppercase tracking-wide">WhatsApp</span>
          </a>
          <a href="#appointment" aria-label="Book an appointment" className="flex-1 py-3 flex flex-col items-center justify-center gap-1 text-medical-blue hover:bg-blue-50 transition-colors">
            <Calendar size={20} />
